...
### Pan C - Launching from Terminal

With time you will come to realise that certain actions are faster to excecute from your command promt (Windows) / Terminal (Mac). This might look scary at first, but overtime it might become more natural to launch Jupyter Lab directly from the terminal. 
