...
The course does not use any specific resources. It is designed to run entirely
on students' machines using solely open-source software.

## Communication

Scholars enrolled in the Sustainable Cities program at the Norman Foster Institute have been 
added to a Google Spaces for online discussion. Scholars are encouraged to use the platform to seek
...
![Shutting down Jupyter Lab](../assets/chapter_0/shut_down.png)
