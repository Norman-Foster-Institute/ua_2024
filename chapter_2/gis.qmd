...
![Raster image grid cells](chapter_2/images/raster_grid.png)
---
...
![Dimaxion Fuller projection. NFF image rights.](chapter_2/images/fuller_nff.png)
...
```{=html}
<iframe width="780" height="500" src="https://gisgeography.com/map-projection-types/" title="Webpage example"></iframe>
```
---
...
```{=html}
<iframe width="780" height="600" src="https://gisgeography.com/maup-modifiable-areal-unit-problem/" title="Webpage example"></iframe>
```
...
```{=html}
<iframe width="780" height="400" src="https://www.youtube.com/watch?v=7NTw1v7DuAA" title="MAUP Crime Data example"></iframe>
```
