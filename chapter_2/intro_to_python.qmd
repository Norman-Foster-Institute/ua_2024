...
- Python is more verstaile than the `R` language, which is sometimes popular with dedicated academics, statisticians, or geographers. You are free to learn `R` and other languages, but please don't get caught up in needless comparisonsn or distractions.
