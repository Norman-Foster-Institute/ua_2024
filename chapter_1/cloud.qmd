...
> ![Use GitHub login](./images/carto_login.png){width=60%}
...
![](./images/carto_add_source.png){fig-align="center" width="40%"}
...
![Show data table](./images/carto_shsow_table.png){fig-align="center" width="40%"}
:::
...
![](./images/carto_builder_tabs.png){fig-align="center" width="50%"}

### Publish
When you are happy with the results makesure you `SHARE` your results by publishing them to allow for **public access**
...
> SQL Procedure for you to have a head start. [DOWNLOAD SQL](./data/workflow_mad_population.sql)
