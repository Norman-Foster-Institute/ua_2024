...
![Show data table](./images/carto_shsow_table.png){fig-align="center" width="300"}
:::
...
> SQL Procedure for you to have a head start. [DOWNLOAD SQL](./data/workflow_mad_population.sql "download")
