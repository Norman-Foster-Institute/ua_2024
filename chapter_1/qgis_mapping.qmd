...
A common mistake in geospatial statistical analysis is when group-level (aggregated) observations are applied to individuals. Correlations can be different, and may even flip, when calculated 
